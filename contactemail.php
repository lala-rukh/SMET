	...
	if (!$conn) {
		...
		if(!preg_match($email_exp,$from)) {
			...
			else
			{
				...
				$sql = "INSERT IGNORE INTO `contact_us` (`fname`, `lname`, `email`, `phone_number`, `comments`, `created_date`, `is_email_sent`) VALUES ('$first_name', '$last_name', '$from', '$number', '$comments', NOW(), '1')";
